...
string names[50] = {"Millan Noor", "Mariam", "Tahira", "Nelofar", "Shaista", "Kiran ", "Fida", "Fahad", "Sir Ismail", "Fatima", "Hiba", "Haris", "Isra", "Ishfaq", "Juniad"};
...
void createRecord() {
    ...
    // Add new student
    for (int i = 0; i < 50; i++) {
        if (roll_no[i] == 0) { // Find an empty spot
            roll_no[i] = rollnum;
